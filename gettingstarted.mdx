...
<img
  height="200"
  src="https://mintlify.s3.us-west-1.amazonaws.com/polar/assets/welcome.png"
/>
...
<AccordionGroup>
  <Accordion title="Integrate with 5 Lines of Code" icon="code">
    ...
    ```bash
    pnpm install @loops-fi/nextjs zod
    ```

    ```typescript
    // checkout/route.ts
    import { Checkout } from "@loops-fi/nextjs";
    
    export const GET = Checkout({
      accessToken: process.env.LOOPS_ACCESS_TOKEN,
  ...
  <Accordion title="Powerful Checkout" icon="money-bill">
    <img
      ...
      src="https://mintlify.s3.us-west-1.amazonaws.com/polar/assets/introduction/checkout.light.png"
    />

    <img
      className="hidden dark:block"
      src="https://mintlify.s3.us-west-1.amazonaws.com/polar/assets/introduction/checkout.dark.png"
    />
...
<img
  className="block dark:hidden"
  src="https://mintlify.s3.us-west-1.amazonaws.com/polar/assets/create-org.light.png"
/>

<img
  className="hidden dark:block"
  src="https://mintlify.s3.us-west-1.amazonaws.com/polar/assets/create-org.dark.png"
/>
